...
namespace ProjectMagma.Renderer
{
    ...
    {
        public LightManager(Renderer renderer)
        {
            // initialize blueish sky light
            SkyLight = new ParallelLight(
                //new Vector3(112, 213, 255) / 255.0f * 1f,
                renderer.EntityManager["lights"].GetVector3("sky_light_color"),
                //Vector3.One * 1.0f,
              //  Vector3.One * 1.0f,
                //new Vector3(0, -1, -0.3f)
                renderer.EntityManager["lights"].GetVector3("sky_light_direction")
            ...
            lavaBaseColor = renderer.EntityManager["lights"].GetVector3("lava_light_color");
            ...
            (
               ...
               // Vector3.One * 1.0f,
                //new Vector3(0, 1, -1)
                renderer.EntityManager["lights"].GetVector3("lava_light_direction")
            );
            ...
            (
               ...
               renderer.EntityManager["lights"].GetVector3("spot_light_color"),
               // Vector3.One * 1.0f,
                SpotLightDirection()
            );
        }
