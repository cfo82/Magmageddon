...
{
    public class DoublyIntegratedVector2
    {
        #region constructors

        public DoublyIntegratedVector2(
            Vector2 start, Vector2 d_start
        )
        {
            this.value = start;
        ...
        {
            Vector2 old_d_value = d_value;
            Vector2 old_value = value;
        ...
        {
            Vector2 biased_normalized_random = new Vector2
            (
            ...
            if (bias < 0.0f)
            {
                biased_normalized_random = Vector2.One - biased_normalized_random;
            }

            // sign and scale
            Vector2 dd_value = (2 * biased_normalized_random - Vector2.One);
            dd_value *= amplitude;
