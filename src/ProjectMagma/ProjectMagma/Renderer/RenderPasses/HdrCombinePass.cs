...
namespace ProjectMagma.Renderer
{
    public class HdrCombinePass : RenderPass
    {
        ...
        private float[] BloomSensitivity = { 0.35f, 0.0f, 0.0f };

        private float[] BloomIntensity = { 0.5f, 0.7f, 2.0f };
        private float[] BaseIntensity = { 1.0f, 0.8f, 1.0f };

        private float[] BloomSaturation = { 1.0f, 0.8f, -1.0f };
        ...
        private float[] In2 = { 2.0f, 2.7f, 1.0f };
        //private float[] Out2 = { 2.0f, 20.0f, 1.0f };
        private float[] Out2 = { 2.0f, 10.0f, 1.0f };
    }
}
